...
The active baseline is version 2.4.0 on Node 24 with its checked-in lockfile. Older deployments and legacy approved rows require review. A `main` branch name alone does not prove that a host runs the latest release.
