...
const sectionsEn = [
  { title: "1. Purpose and Scope", text: "IRB Saudi Arabia is an independent ethical review platform operated by Advanced Healthcare Systems Society (AHSS · ahss-sa.org). It is not an official Institutional Review Board provider of the National Committee of BioEthics (NCBE) of Saudi Arabia. The platform facilitates structured IRB-style review of research involving human subjects for researchers and institutions in the Kingdom, in compliance with PDPL, NCBE ethical guidelines, the Declaration of Helsinki, ICH-GCP, and Saudi Vision 2030 digitalization goals." },
...
const sectionsAr = [
  { title: "١. الغرض والنطاق", text: "IRB السعودية منصة مستقلة للمراجعة الأخلاقية تُشغّلها جمعية أنظمة الرعاية الصحية المتقدمة (AHSS · ahss-sa.org). ليست جهة IRB رسمية تابعة للجنة NCBE. تُسهّل مراجعة أخلاقية منظمة للبحوث التي تشمل البشر، وفق PDPL وإرشادات NCBE الأخلاقية وإعلان هلسنكي وICH-GCP ورؤية 2030." },
...
export default function Policy() {
  ...
  const lastUpdated = new Date("2026-06-11T00:00:00Z");
