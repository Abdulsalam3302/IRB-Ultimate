...
const sectionsEn = [
  { title: "1. Purpose and Scope", text: "This IRB Review Platform is established under the authority of the National Bioethics Committee of Saudi Arabia (NBCE) to facilitate the ethical review and approval of research involving human subjects. The platform serves researchers, institutions, and committee members across the Kingdom of Saudi Arabia. All research activities requiring IRB approval, including but not limited to clinical trials, observational studies, surveys, and behavioral research, must comply with these terms." },
  ...
  { title: "3. Application Process", text: "The application process consists of two stages. Stage 1 requires classification of the research type and basic project information. Stage 2 requires detailed methodology, ethics considerations, and supporting documentation. Each stage undergoes an AI-powered compliance check that evaluates adherence to NBCE guidelines, the Declaration of Helsinki, the Belmont Report, and ICH-GCP standards. A minimum score of 70/100 is required at each stage to proceed." },
  { title: "4. AI-Powered Review", text: "The platform employs artificial intelligence to pre-screen applications for compliance and completeness. The AI review is advisory in nature and does not replace human committee review. AI scores and feedback are provided to help applicants improve their submissions before committee review. The AI system evaluates ethical compliance, methodological soundness, informed consent adequacy, risk-benefit ratios, and data protection measures." },
  ...
  { title: "10. Administrator Authority", text: "The platform administrator has full authority to manage committee membership, override random assignments, make final approval or rejection decisions, and access all platform metrics and audit logs. The administrator acts on behalf of the NBCE and ensures that all platform operations comply with national regulations and ethical standards." },
  { title: "11. Compliance with Regulations", text: "All users of this platform must comply with the regulations set forth by the National Bioethics Committee of Saudi Arabia, the Saudi Food and Drug Authority (SFDA) where applicable, and international ethical research standards including the Declaration of Helsinki (2013), the Belmont Report, ICH Guidelines for Good Clinical Practice (ICH-GCP), and the Council for International Organizations of Medical Sciences (CIOMS) guidelines." },
...
const sectionsAr = [
  { title: "١. الغرض والنطاق", text: "تم إنشاء منصة مراجعة IRB هذه تحت إشراف اللجنة الوطنية للأخلاقيات الحيوية في المملكة العربية السعودية (NBCE) لتسهيل المراجعة الأخلاقية والموافقة على البحوث التي تشمل البشر. تخدم المنصة الباحثين والمؤسسات وأعضاء اللجان في جميع أنحاء المملكة العربية السعودية." },
  ...
  { title: "٤. المراجعة بالذكاء الاصطناعي", text: "تستخدم المنصة الذكاء الاصطناعي لفحص الطلبات مسبقاً للتحقق من الامتثال والاكتمال. مراجعة الذكاء الاصطناعي استشارية بطبيعتها ولا تحل محل مراجعة اللجنة البشرية. يتم تقديم درجات وملاحظات الذكاء الاصطناعي لمساعدة المتقدمين على تحسين طلباتهم." },
        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          ...
          <div className="border-t pt-6 mt-10">
            <p className="text-sm text-muted-foreground">
              {isAr ? "آخر تحديث: " : "Last updated: "}{new Date().toLocaleDateString(isAr ? "ar-SA" : "en-US", { year: "numeric", month: "long", day: "numeric" })}
            </p>
