...
export const TEMPLATE_SECTIONS: Record<string, TemplateSection[]> = {
      ...
      fields: [
        {
          ...
          exampleAr: "د. فاطمة الرashid، MD، PhD",
          blankLines: 1,
        },
        {
          id: "pi_institution",
          ...
          exampleAr: "جامعة الملك Saud، كلية الطب — fatimah.r@ksu.edu.sa — +966 50 123 4567 — ORCID: 0000-0002-1825-0097",
          blankLines: 2,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          exampleAr: "د. أحمد العتيبي — باحث مشارك — KSU — ahmed.o@ksu.edu.sa",
          blankLines: 3,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          exampleEn: "I declare all information is truthful. I will conduct research per NBCE and Helsinki.\nSignature: _________________ Date: __________",
          exampleAr: "أُقرّ أن المعلومات صحيحة. سأُجري البحث وفق NBCE وهلسنكي.\nالتوقيع: _________________ التاريخ: __________",
          blankLines: 2,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          exampleAr: "استبيان رفاهية الممارسين | الباحث: د. فاطمة | fatimah.r@ksu.edu.sa",
          blankLines: 2,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          hintAr: "الأعمال السابقة، الفجوة، لماذا مطلوبة الآن.",
          exampleEn: "Regional burnout data sparse. This study surveys 400 clinicians using validated MBI.",
          exampleAr: "بيانات الإرهاق محدودة. هذه الدراسة تستبين 400 ممارس باستخدام MBI المعتمد.",
          blankLines: 4,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          labelAr: "الأهداف الأولية والثانوية",
  ...
  "data-collection-instrument": [
    ...
    },
    {
      ...
      headingAr: "القسم ب — الديموغرافيا",
      fields: [
        {
          id: "demographics",
